  ...
  <q-dialog v-model="isOpened" persistent>
    <div class="tw-p-6 tw-shadow-md tw-bg-white tw-gap-4" style="width: 400px; max-width: 90vw;">
      <q-form 
        ...
        @submit="onSubmit"
      >
        <h2 class="tw-text-xl tw-text-primary">Extraer Productos</h2> <!-- NOTE: replaceable -->
...
const onSubmit = async () => {
  ...
  if (status){
    ...
    const filename = `Nota de salida ${format(new Date(), 'yyyy-MM-dd')}.txt`; 
